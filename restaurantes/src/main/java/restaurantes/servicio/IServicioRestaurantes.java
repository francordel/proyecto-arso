...
public interface IServicioRestaurantes {
	...
	/*
	 * crearOpinion. Esta operación realiza el alta de un restaurante en el
	 * servicio Opiniones. Parámetro: id del restaurante.
	 */
	void crearOpinion(String idRestaurante) throws RepositorioException, EntidadNoEncontrada;
	/*
	 * getValoraciones. Recuperar valoraciones de un restaurante. Parámetro: identificador del
	 * restaurante. Si se ha activado el servicio Opiniones para el restaurante,
	 * retorna todas las valoraciones.
	 */
	List<Valoracion> getValoraciones(String idRestaurante) throws RepositorioException, EntidadNoEncontrada;
}
